...
const Settings = () => {
  ...
  const handleExportData = (format: string) => {
    toast({
      title: `डेटा ${format} में निर्यात हो रहा है...`,
  ...
  const handleDeleteAccount = () => {
    ...
    toast({
      title: "खाता हटाने का अनुरोध भेजा गया",
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const updated = farms.map((f) =>
                            f.id === farm.id ? { ...f, name: e.target.value } : f
                          );
                          setFarms(updated);
                        }}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          onChange={(e) => {
                            const updated = farms.map((f) =>
                              f.id === farm.id ? { ...f, size: e.target.value } : f
                            );
                            setFarms(updated);
                          }}
                        />
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          const updated = farms.map((f) =>
                            f.id === farm.id ? { ...f, soilType: value } : f
                          );
                          setFarms(updated);
                        }}
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const updated = farms.map((f) =>
                            f.id === farm.id ? { ...f, crops: e.target.value } : f
                          );
                          setFarms(updated);
                        }}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          const updated = farms.map((f) =>
                            f.id === farm.id ? { ...f, irrigation: value } : f
                          );
                          setFarms(updated);
                        }}
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          const updated = farms.map((f) =>
                            f.id === farm.id ? { ...f, farmingType: value } : f
                          );
                          setFarms(updated);
                        }}
                      >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-4 border-t">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSecurity({ ...security, dataSharing: checked })
                    }
                  />
                </div>
                  ...
                  <Dialog open={clearDataDialogOpen} onOpenChange={setClearDataDialogOpen}>
                    ...
                    <DialogContent className="bg-card">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          This will clear all cached data. You may need to re-enter some
                          information.
                        </DialogDescription>
                      </DialogHeader>
                      <DialogFooter>
              ...
              <div className="pt-4 border-t">
                ...
                <div className="bg-primary/5 rounded-lg p-4 space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    >
                      support@fasalguru.com
                    </a>
                  </div>
                  <div className="flex items-center gap-3">
                    <Phone className="h-5 w-5 text-primary" />
                    <a href="tel:9569393106" className="text-primary hover:underline">
                      +91 9569393106
                    </a>
                  </div>
                  <div className="flex items-center gap-3">
